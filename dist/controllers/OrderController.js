...
var Order_1 = require("../database/entities/Order");
var OrderController = /** @class */ (function () {
    function OrderController() {
        var _this = this;
        this.listOrders = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        this.createOrder = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var description, order, result, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        ...
                        return [4 /*yield*/, data_source_1.AppDataSource.manager.save(order)];
                    case 1:
                        result = _a.sent();
                        res.json(result);
                        return [3 /*break*/, 3];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        orderRepository = data_source_1.AppDataSource.getRepository(Order_1.Order);
                        return [4 /*yield*/, orderRepository.findOneByOrFail({ id: Number(req.params.orderId) })];
                    case 1:
                        order = _a.sent();
                        res.json(order);
                        return [3 /*break*/, 3];
        ...
        this.updateOrder = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var orderRepository, order, description, result, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        order = _a.sent();
                        description = req.body.description;
                        order.description = description !== null && description !== void 0 ? description : order.description;
        ...
        this.deleteOrder = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var orderRepository, order, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        order = _a.sent();
                        return [4 /*yield*/, orderRepository.softDelete({ id: Number(order.id) })];
                    case 2:
                        _a.sent();
